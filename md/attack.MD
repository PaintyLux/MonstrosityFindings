...
$`
Attack = \lfloor Base ATK \cdot (1 + Species Boost_{ATK}) \cdot (1 + \sum Instinct ATK_{\%}) \rfloor
`$

$`
Base ATK = 8 + CombatSkill_{A+} + \lfloor \frac{STR}{2} \rfloor + \sum InstinctATK_{Flat}
`$
